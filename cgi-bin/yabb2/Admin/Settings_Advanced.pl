...
$settings_advancedplver = 'YaBB 2.6 $Revision: 1.0 $';
...
qq~<input type="checkbox" name="checkext" id="checkext" value="1" ${ischecked($checkext)}/>~,
            ...
            },
            {
                ...
                input_html =>
qq~<input type="text" name="extensions" id="extensions" size="35" value="~
                  . join( ' ', @ext )
                  . qq~" />~,
                name       => 'extensions',
                validate   => 'text',
...
qq~<input type="checkbox" name="faketruncation" id="faketruncation" value="1" ${ischecked($faketruncation)}/>~,
            ...
            { header => $settings_txt{'freedisk'}, },
            {
                ...
                input_html =>
qq~<input type="checkbox" name="enable_quota" id="enable_quota" value="1" ~
                  . (
...
qq~<label for="enable_quota_value">$admin_txt{'quota_value'}</label>~,
                input_html => (
                    ...
                    : qq~<input type="hidden" name="enable_quota_value" id="enable_quota_value" value="0" />~
                ),
...
qq~<input type="text" name="hostusername" id="hostusername" size="20" value="$hostusername" />~,
            ...
            },
            {
                ...
                input_html =>
qq~<input type="text" name="findfile_time" id="findfile_time" size="4" value="~
