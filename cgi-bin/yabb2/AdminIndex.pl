...
$adminindexplver = 'YaBB 2.6 $Revision: 1.0 $';
...
sub AdmImgLoc2 {
    if ( !-e "$forumstylesdir/$useimages/$_[0]" ) {
        $thisimgloc = qq~$forumstylesurl/default/$_[0]~;
    }
...
sub AdminTemplate {
    ...
    if ( !-d "$adminstylesdir/$admin_template" || $admin_template eq "" ) {
        $admin_template = "default";
    }

    $adminstyle =
qq~<link rel="stylesheet" href="$adminstylesurl/$admin_template.css" type="text/css" />~;
...
qq~<br /><span style="font-size: 12px; background-color: #FFFF33;"><b>$load_txt{'617'} ~
    ...
    $mainbody =~
s~img src\=\&quot\;$imagesdir\/(.+?)\&quot;~"img src\=\&quot;" . &AdmImgLoc2($1) . "\&quot;"~eisg
